...
- **Vocabulary** — **35 thematic word packs (~690 words)** spanning family, school, daily routine, house, food & cooking, body/health & the doctor, clothing & colors, hobbies, jobs & the office, the city, technology, nature & geography, animals, weather & seasons, descriptions & character, emotions, the calendar, numbers, common & movement verbs, money & shopping, travel, household chores, life events, people & relationships, culture, quantities, question words, connectors and useful expressions — all browsable, tap-to-hear, and addable to spaced repetition
...
Michelle now spans **CEFR A1 → B1+ (≈ US high-school Spanish 1–4 / AP)**: ~1,000 lexical items and phrases, five verb tenses, and grammar from greetings through the preterite/imperfect, future, conditional, and reflexive verbs. The vocabulary library keeps growing toward full high-school/AP breadth (~1,500 words).
